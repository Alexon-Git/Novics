...
const HeaderRight = () => {
  ...
  return (
    <div className="navbar-end">
      {!currentUser || !currentUser.is_active ? <button onClick={() => dispatch(openSignInModal())} className="btn btn-secondary text-base-100 px-6">Личный кабинет</button> : <ProfileLink />}
    </div>
  )
}
