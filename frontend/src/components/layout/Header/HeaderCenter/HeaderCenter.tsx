    ...
    <>
      <div className="navbar-center hidden lg:flex lg:gap-32">
                ...
                <li key={link.id}>
                  <NavLink
                    ...
                    className={({ isActive, isPending }) =>
                      isPending
                        ? 'font-medium text-sm focus:text-base-100'
                        : isActive
                          ? 'font-semibold font-sm focus:text-base-100'
                          : 'focus:text-base-100 opacity-70'
                    }
                  >
                    {link.title}
                  </NavLink>
        ...
        <label className="input border-[#BBBBBB] text-[#D5D5D5] bg-transparent rounded-[15px] px-3 h-9 flex items-center gap-2">
          ...
          >
            <g clip-path="url(#clip0_28_76669)">
              <path
          ...
          <input type="text" className="grow text-sm placeholder:text-[#D5D5D5]" placeholder="Поиск" />
        </label>
      </div>
    </>
  )
