...
import { closeModal, openSignInModal, openSignUpModal } from '../../../store/modals/modalReducer'
...
const SignModal = () => {
  ...
  const isSignUpModalOpen = useSelector(
    (state: RootStore) => state.modalReducer.isSignUpModalOpen
  )
  const isOpen = useSelector((state: RootStore) => state.modalReducer.isOpen)
