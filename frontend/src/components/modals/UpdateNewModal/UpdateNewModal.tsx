...
import { useRef, useEffect, FC, useState, SyntheticEvent } from 'react'
...
const UpdateNewModal: FC<IUpdateModal> = ({ news, isOpen, setIsOpen }) => {
  ...
  const mutation = useMutation({
    mutationFn: NewsService.patchNewById,
    onError: () => {
  ...
  const submit = (event: SyntheticEvent) => {
    ...
    mutation.mutate({ newData: formData as Partial<INewsCard>, id: news.id })
  }
