  ...
  return (
    <div className="w-full flex justify-between items-center gap-48">
      <div className="w-1/4 flex flex-col gap-4">
        <div className="h-full min-h-[300px] w-full bg-[#D9D9D9] flex justify-center items-center rounded-2xl">
          <svg
            width="50"
            height="50"
            viewBox="0 0 50 50"
      ...
      <form className="flex flex-col gap-4">
        <input
          type="file"
          className="file-input file-input-bordered rounded-[10px] w-full"
        />
        <input type="text" className=' input input-bordered rounded-[10px] w-full' />
      </form>
    </div>
  )
}
